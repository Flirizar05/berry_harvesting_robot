...
def generate_launch_description():
    ...
    mount_x_arg = DeclareLaunchArgument("cam_x", default_value="-0.04439")
    mount_y_arg = DeclareLaunchArgument("cam_y", default_value="0.00039")
    mount_z_arg = DeclareLaunchArgument("cam_z", default_value="0.04472")
    ...
    static_end_to_tool0 = Node(
        ...
        name="end_effector_link_to_tool0",
        arguments=[
            "0", "0", "0",
            "0", "0", "0",
            "end_effector_link",
